...
<a id="button"></a>
		...
		<div class="row text-center">
	<div class="col">
<div class="napisek03 bg-danger text-white">
	...
	<div class="row text-center">
	<div class="col">
	<div class="card border-danger mb-3" style="width: 100%; opacity:0.9;">
  

   
    <p class="card-text text-center" style="font-size:19px;">
...
while($rak = mysqli_fetch_object($wyniki555))
	...
	echo'	<div class="card text-white bg-info mb-3" style="width: 100%; opacity:0.9; font-size:19px;">';
...
print '<div class="opis"><p>'.$r->opis.'</br></br>Czas trwania: '.$r->czas_trwania.'</br></br>Cena: '.$r->cena. ' zł </br></div>';
echo'</div>';
echo'</div>';
...
echo'<div class="row text-center">';
	echo'<div class="col">';
		...
		foreach ($day_array as $day_value => $day_string) {
		 ...
		 print '<div class="day"><form style="color:chartreuse;">'.$day_string.'</b></br>';
                    $day = $day_value;
                    $title = $r->nazwa;
    ...
    $dzien111 = date('N', strtotime($data23));
					...
					print '<a href="wybor.php?id_seans='.$re->id.'" title="Rezerwacja niedostępna"><input type="button" style="background:grey;" disabled name="godz" value="'.$bez_sekund.'"/></a>';
