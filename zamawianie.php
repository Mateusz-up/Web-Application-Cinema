...
<a id="button"></a>
	...
	<div class="card border-success mb-3 text-center" style="max-width: 20rem;margin-right: auto;margin-left: auto; ">
	...
	<?php
		...
		echo'<br><br>';
		echo"<input type='submit' class='btn btn-success' value='Zamawiam'>";
