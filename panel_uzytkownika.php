...
?>
	...
	echo'<div class="card text-white bg-warning mb-3" style="width:100%;">';
	...
	echo'<div class="Logowanie1"><a href="showzamowienie.php">Status zamówienia biletu</a></div>';
	echo'</div>';
	echo'<br><br>';

	echo'<div class="col-sm-4">';
	echo'<div class="Logowanie22"><a href="wyswietlanie_koszyka.php">Przejdź do koszyka</a></div>';
	echo'</div>';
	echo'<br><br>';

	echo'<div class="col-sm-4">';
	echo'<div class="Logowanie33"><a href="index.php">Przejdż do kina</a></div>';
	echo'</div>';
